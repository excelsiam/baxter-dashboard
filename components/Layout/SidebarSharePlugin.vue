    ...
    <div class="dropdown show-dropdown" :class="{ show: isOpen }">
      ...
      <ul class="dropdown-menu" :class="{ show: isOpen }">
        ...
        <li class="button-container mt-4">
          ...
          <a href="https://creative-tim.com/product/nuxt-black-dashboard-pro" target="_blank" rel="noopener" class="btn btn-primary btn-block btn-round">
            Buy for $79
          </a>
          <a href="https://demos.creative-tim.com/vue-black-dashboard" target="_blank" rel="noopener" class="btn btn-info btn-block btn-round">
            Free Version
          </a>
        </li>
      </ul>
