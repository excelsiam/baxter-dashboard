    ...
    <card>
      ...
      <div>
        <div class="row">
          ...
          <div class="col-sm-7">
            <base-input name="required" v-validate="modelValidations.required" v-model="model.required" :error="getError('required')"> </base-input>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-7">
            <base-input name="email" v-validate="modelValidations.email" v-model="model.email" :error="getError('email')"> </base-input>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-7">
            <base-input name="number" v-validate="modelValidations.number" v-model="model.number" :error="getError('number')"> </base-input>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-7">
            <base-input name="url" v-validate="modelValidations.url" v-model="model.url" :error="getError('url')"> </base-input>
          </div>
      ...
      <div class="text-center">
        <base-button native-type="submit" @click.native.prevent="validate" type="primary">Validate inputs</base-button>
      </div>
    </card>
  </form>
</template>
