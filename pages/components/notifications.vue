        ...
        <div class="places-buttons">
          ...
          <div class="row">
            <div class="col-lg-8 ml-auto mr-auto">
              <div class="row">
                <div class="col-md-4">
                  <base-button type="primary" block @click.native="notifyVue('top', 'left')">Top Left </base-button>
                </div>
                <div class="col-md-4">
                  <base-button type="primary" block @click.native="notifyVue('top', 'center')">Top Center </base-button>
                </div>
                <div class="col-md-4">
                  <base-button type="primary" block @click.native="notifyVue('top', 'right')">Top Right </base-button>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-8 ml-auto mr-auto">
              <div class="row">
                <div class="col-md-4">
                  <base-button type="primary" block @click.native="notifyVue('bottom', 'left')">Bottom Left </base-button>
                </div>
                <div class="col-md-4">
                  <base-button type="primary" block @click.native="notifyVue('bottom', 'center')">Bottom Center </base-button>
                </div>
                <div class="col-md-4">
                  <base-button type="primary" block @click.native="notifyVue('bottom', 'right')">Bottom Right </base-button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12 text-center">
            ...
            <modal :show.sync="modals.classic" headerClasses="justify-content-center">
              ...
              <p>
                ...
                the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.
              </p>
                ...
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <p class="description">
                      ...
                      <a href="http://www.creative-tim.com/">Creative Tim</a>. You can choose a social network or go for the classic version, whatever works
                      best for you.
                    </p>
                  </div>
                  <div class="col-md-4">
            ...
            <!-- small modal -->
            <modal :show.sync="modals.mini" class="modal-primary" :show-close="false" headerClasses="justify-content-center" type="mini">
